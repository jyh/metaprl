...
(* ************************** rules ************************* *)
interactive boolset_isset {| intro [] |} 'H :
   sequent ['ext] { 'H >- isset{boolset} }

interactive boolset_elim {| elim [] |} 'H 'J :
...
interactive snot_member_elim {| elim [] |} 'H 'J :
...
interactive sor_intro_left {| intro [SelectOption 1] |} 'H :
...
interactive sor_intro_right {| intro [SelectOption 2] |} 'H :
   ["wf"] sequent [squash] { 'H >- isset{'s1} } -->
   ["wf"] sequent [squash] { 'H >- isset{'s2} } -->
...
interactive sor_member_intro_left {| intro [SelectOption 1] |} 'H :
   ["wf"] sequent [squash] { 'H >- isset{'x} } -->
   ["wf"] sequent [squash] { 'H >- isset{'s1} } -->
   ["wf"] sequent [squash] { 'H >- isset{'s2} } -->
...
interactive sor_member_intro_right {| intro [SelectOption 2] |} 'H :
   ["wf"] sequent [squash] { 'H >- isset{'x} } -->
   ["wf"] sequent [squash] { 'H >- isset{'s1} } -->
   ["wf"] sequent [squash] { 'H >- isset{'s2} } -->
...
interactive sor_member_elim {| elim [] |} 'H 'J :
...
(* ************************** sand ************************* *)
interactive sand_isset {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'a} } -->
   sequent [squash] { 'H >- isset{'b} } -->
   sequent ['ext] { 'H >- isset{sand{'a; 'b}} }

interactive sand_fun {| intro [] |} 'H :
   sequent ['ext] { 'H >- fun_set{z. 's1['z]} } -->
   sequent ['ext] { 'H >- fun_set{z. 's2['z]} } -->
   sequent ['ext] { 'H >- fun_set{z. sand{'s1['z]; 's2['z]}} }

interactive sand_sprop1 {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'s} } -->
   sequent ['ext] { 'H >- fun_prop{z. sprop{sand{'z; 's}}} }

interactive sand_sprop2 {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'s} } -->
   sequent ['ext] { 'H >- fun_prop{z. sprop{sand{'s; 'z}}} }

interactive sand_in_boolset {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'a} } -->
   sequent ['ext] { 'H >- mem{'a; boolset} } -->
   sequent [squash] { 'H >- isset{'b} } -->
   sequent ['ext] { 'H >- mem{'b; boolset} } -->
...
interactive sand_intro {| intro [] |} 'H :
   ["wf"] sequent [squash] { 'H >- isset{'s1} } -->
   ["wf"] sequent [squash] { 'H >- isset{'s2} } -->
   sequent ['ext] { 'H >- sprop{'s1} } -->
   sequent ['ext] { 'H >- sprop{'s2} } -->
...
interactive sand_elim {| elim [] |} 'H 'J 'y 'z :
...
interactive strue_sand_strue {| intro [] |} 'H :
   sequent ['ext] { 'H >- sprop{sand{strue; strue}} }

interactive strue_sand_sfalse {| elim [] |} 'H 'J :
   sequent ['ext] { 'H; x: sprop{sand{strue; sfalse}}; 'J['x] >- 'C['x] }

interactive sfalse_sand_strue {| elim [] |} 'H 'J :
   sequent ['ext] { 'H; x: sprop{sand{strue; sfalse}}; 'J['x] >- 'C['x] }

interactive sfalse_sand_sfalse {| elim [] |} 'H 'J :
   sequent ['ext] { 'H; x: sprop{sand{sfalse; sfalse}}; 'J['x] >- 'C['x] }

interactive sand_strue_intro1 {| intro [] |} 'H :
   sequent ['ext] { 'H; s: set; x: sprop{'s} >- sprop{sand{strue; 's}} }

interactive sand_strue_intro2 {| intro [] |} 'H :
   sequent ['ext] { 'H; s: set; x: sprop{'s} >- sprop{sand{strue; 's}} }

interactive sand_sfalse_elim1 {| elim [] |} 'H 'J :
...
interactive sand_sfalse_elim2 {| elim [] |} 'H 'J :
...
interactive sand_member_intro {| intro [] |} 'H :
   ["wf"] sequent [squash] { 'H >- isset{'x} } -->
   ["wf"] sequent [squash] { 'H >- isset{'s1} } -->
   ["wf"] sequent [squash] { 'H >- isset{'s2} } -->
   sequent ['ext] { 'H >- mem{'x; 's1} } -->
...
interactive sand_member_elim {| elim [] |} 'H 'J :
...
(* ************************** simplies ************************* *)
interactive simplies_isset {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'a} } -->
   sequent [squash] { 'H >- isset{'b} } -->
   sequent ['ext] { 'H >- isset{simplies{'a; 'b}} }

interactive simplies_fun {| intro [] |} 'H :
   sequent ['ext] { 'H >- fun_set{z. 's1['z]} } -->
   sequent ['ext] { 'H >- fun_set{z. 's2['z]} } -->
   sequent ['ext] { 'H >- fun_set{z. simplies{'s1['z]; 's2['z]}} }

interactive simplies_sprop1 {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'s} } -->
   sequent ['ext] { 'H >- fun_prop{z. sprop{simplies{'s; 'z}}} }

interactive simplies_sprop2 {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'s} } -->
   sequent ['ext] { 'H >- fun_prop{z. sprop{simplies{'z; 's}}} }

interactive simplies_in_boolset {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'a} } -->
   sequent [squash] { 'H >- isset{'b} } -->
   sequent ['ext] { 'H >- mem{'a; boolset} } -->
   sequent ['ext] { 'H >- mem{'b; boolset} } -->
...
interactive simplies_intro {| intro [] |} 'H :
   ["wf"] sequent [squash] { 'H >- isset{'s1} } -->
   ["wf"] sequent [squash] { 'H >- isset{'s2} } -->
   sequent ['ext] { 'H >- mem{'s1; boolset} } -->
   sequent ['ext] { 'H >- mem{'s2; boolset} } -->
...
interactive simplies_elim {| elim [] |} 'H 'J :
...
(* ************************** siff ************************* *)
interactive siff_isset {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'a} } -->
   sequent [squash] { 'H >- isset{'b} } -->
   sequent ['ext] { 'H >- isset{siff{'a; 'b}} }

interactive siff_fun {| intro [] |} 'H :
   sequent ['ext] { 'H >- fun_set{z. 's1['z]} } -->
   sequent ['ext] { 'H >- fun_set{z. 's2['z]} } -->
   sequent ['ext] { 'H >- fun_set{z. siff{'s1['z]; 's2['z]}} }

interactive siff_sprop1 {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'s} } -->
   sequent ['ext] { 'H >- fun_prop{z. sprop{siff{'z; 's}}} }

interactive siff_sprop2 {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'s} } -->
   sequent ['ext] { 'H >- fun_prop{z. sprop{siff{'s; 'z}}} }

interactive siff_in_boolset {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'a} } -->
   sequent [squash] { 'H >- isset{'b} } -->
   sequent ['ext] { 'H >- mem{'a; boolset} } -->
   sequent ['ext] { 'H >- mem{'b; boolset} } -->
...
interactive siff_intro {| intro [] |} 'H :
   ["wf"] sequent [squash] { 'H >- isset{'s1} } -->
   ["wf"] sequent [squash] { 'H >- isset{'s2} } -->
   sequent ['ext] { 'H >- mem{'s1; boolset} } -->
   sequent ['ext] { 'H >- mem{'s2; boolset} } -->
...
interactive siff_elim {| elim [] |} 'H 'J :
...
(* ************************** scand ************************* *)
interactive scand_isset {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'a} } -->
   sequent [squash] { 'H >- isset{'b} } -->
   sequent ['ext] { 'H >- isset{scand{'a; 'b}} }

interactive scand_fun {| intro [] |} 'H :
   sequent ['ext] { 'H >- fun_set{z. 's1['z]} } -->
   sequent ['ext] { 'H >- fun_set{z. 's2['z]} } -->
   sequent ['ext] { 'H >- fun_set{z. scand{'s1['z]; 's2['z]}} }

interactive scand_sprop1 {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'s} } -->
   sequent ['ext] { 'H >- fun_prop{z. sprop{scand{'z; 's}}} }

interactive scand_sprop2 {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'s} } -->
   sequent ['ext] { 'H >- fun_prop{z. sprop{scand{'s; 'z}}} }

interactive scand_in_boolset {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'a} } -->
   sequent ['ext] { 'H >- mem{'a; boolset} } -->
   sequent [squash] { 'H >- isset{'b} } -->
   sequent ['ext] { 'H >- mem{'b; boolset} } -->
...
interactive scand_intro {| intro [] |} 'H 'x :
   ["wf"] sequent [squash] { 'H >- isset{'s1} } -->
   ["wf"] sequent [squash] { 'H >- isset{'s2} } -->
   sequent ['ext] { 'H >- sprop{'s1} } -->
   sequent ['ext] { 'H; x: sprop{'s1} >- sprop{'s2} } -->
...
interactive scand_elim {| elim [] |} 'H 'J 'y 'z :
...
interactive scand_strue {| elim [] |} 'H 'J :
...
interactive scand_sfalse1 {| elim [] |} 'H 'J :
   ["wf"] sequent [squash] { 'H; x: sprop{scand{'s1; 's2}}; 'J['x] >- isset{'s1} } -->
   ["wf"] sequent [squash] { 'H; x: sprop{scand{'s1; 's2}}; 'J['x] >- isset{'s2} } -->
(*   sequent ['ext] { 'H; x: sprop{scand{'s1; 's2}}; 'J['x] >- mem{'s1; boolset} } --> *)
   sequent ['ext] { 'H; x: sprop{scand{'s1; 's2}}; 'J['x] >- mem{'s2; boolset} } -->
...
interactive scand_sfalse2 {| elim [] |} 'H 'J :
...
(* ************************** scor ************************* *)
interactive scor_isset {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'a} } -->
   sequent [squash] { 'H >- isset{'b} } -->
   sequent ['ext] { 'H >- isset{scor{'a; 'b}} }

interactive scor_fun {| intro [] |} 'H :
   sequent ['ext] { 'H >- fun_set{z. 's1['z]} } -->
   sequent ['ext] { 'H >- fun_set{z. 's2['z]} } -->
   sequent ['ext] { 'H >- fun_set{z. scor{'s1['z]; 's2['z]}} }

interactive scor_sprop1 {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'s} } -->
   sequent ['ext] { 'H >- fun_prop{z. sprop{scor{'z; 's}}} }

interactive scor_sprop2 {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'s} } -->
   sequent ['ext] { 'H >- fun_prop{z. sprop{scor{'s; 'z}}} }

interactive scor_in_boolset {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'a} } -->
   sequent ['ext] { 'H >- mem{'a; boolset} } -->
   sequent [squash] { 'H >- isset{'b} } -->
   sequent ['ext] { 'H >- mem{'b; boolset} } -->
...
interactive scor_intro_left {| intro [SelectOption 1] |} 'H 'x :
   ["wf"] sequent [squash] { 'H >- isset{'s2} } -->
   ["wf"] sequent [squash] { 'H >- isset{'s1} } -->
   sequent ['ext] { 'H >- mem{'s1; boolset} } -->
   sequent ['ext] { 'H >- mem{'s2; boolset} } -->
...
interactive scor_intro_right {| intro [SelectOption 2] |} 'H 'x :
   ["wf"] sequent [squash] { 'H >- isset{'s1} } -->
   ["wf"] sequent [squash] { 'H >- isset{'s2} } -->
   sequent ['ext] { 'H >- mem{'s1; boolset} } -->
...
interactive scor_elim {| elim [] |} 'H 'J :
...
(* ************************** sxor ************************* *)
interactive sxor_isset {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'a} } -->
   sequent [squash] { 'H >- isset{'b} } -->
   sequent ['ext] { 'H >- isset{sxor{'a; 'b}} }

interactive sxor_fun {| intro [] |} 'H :
   sequent ['ext] { 'H >- fun_set{z. 's1['z]} } -->
   sequent ['ext] { 'H >- fun_set{z. 's2['z]} } -->
   sequent ['ext] { 'H >- fun_set{z. sxor{'s1['z]; 's2['z]}} }

interactive sxor_sprop1 {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'s} } -->
   sequent ['ext] { 'H >- fun_prop{z. sprop{sxor{'z; 's}}} }

interactive sxor_sprop2 {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'s} } -->
   sequent ['ext] { 'H >- fun_prop{z. sprop{sxor{'s; 'z}}} }

interactive sxor_in_boolset {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'a} } -->
   sequent [squash] { 'H >- isset{'b} } -->
   sequent ['ext] { 'H >- mem{'a; boolset} } -->
   sequent ['ext] { 'H >- mem{'b; boolset} } -->
...
interactive sxor_intro {| intro [] |} 'H 'x :
   ["wf"] sequent [squash] { 'H >- isset{'s1} } -->
   ["wf"] sequent [squash] { 'H >- isset{'s2} } -->
   sequent ['ext] { 'H >- mem{'s1; boolset} } -->
   sequent ['ext] { 'H >- mem{'s2; boolset} } -->
...
interactive sxor_elim {| elim [] |} 'H 'J :
...
interactive sxor_hyp_assoc1 'H 'J 'u :
...
interactive sxor_concl_assoc1 'H :
...
let sxorHypAssoc1T i p =
   ...
   let j, k = Sequent.hyp_indices p i in
      sxor_hyp_assoc1 j k u p

let sxorConclAssoc1T p =
   sxor_concl_assoc1 (hyp_count_addr p) p
...
(* ************************** sxand ************************* *)
interactive sxand_isset {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'a} } -->
   sequent [squash] { 'H >- isset{'b} } -->
   sequent ['ext] { 'H >- isset{sxand{'a; 'b}} }

interactive sxand_fun {| intro [] |} 'H :
   sequent ['ext] { 'H >- fun_set{z. 's1['z]} } -->
   sequent ['ext] { 'H >- fun_set{z. 's2['z]} } -->
   sequent ['ext] { 'H >- fun_set{z. sxand{'s1['z]; 's2['z]}} }

interactive sxand_sprop1 {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'s} } -->
   sequent ['ext] { 'H >- fun_prop{z. sprop{sxand{'z; 's}}} }

interactive sxand_sprop2 {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'s} } -->
   sequent ['ext] { 'H >- fun_prop{z. sprop{sxand{'s; 'z}}} }

interactive sxand_in_boolset {| intro [] |} 'H :
   sequent [squash] { 'H >- isset{'a} } -->
   sequent [squash] { 'H >- isset{'b} } -->
   sequent ['ext] { 'H >- mem{'a; boolset} } -->
   sequent ['ext] { 'H >- mem{'b; boolset} } -->
...
interactive sxand_intro {| intro [] |} 'H 'x :
   ["wf"] sequent [squash] { 'H >- isset{'s1} } -->
   ["wf"] sequent [squash] { 'H >- isset{'s2} } -->
   sequent ['ext] { 'H >- mem{'s1; boolset} } -->
   sequent ['ext] { 'H >- mem{'s2; boolset} } -->
...
interactive sxand_elim {| elim [] |} 'H 'J :
...
interactive sxand_hyp_assoc1 'H 'J 'u :
...
interactive sxand_concl_assoc1 'H :
   [wf] sequent [squash] {'H >- isset{'a} } -->
   [wf] sequent [squash] {'H >- isset{'b} } -->
   [wf] sequent [squash] {'H >- isset{'c} } -->
   sequent ['ext] { 'H >- mem{'a; boolset} } -->
...
let sxandHypAssoc1T i p =
   let u = Var.maybe_new_vars1 p "u" in
   let j, k = Sequent.hyp_indices p i in
      sxand_hyp_assoc1 j k u p

let sxandConclAssoc1T p =
   sxand_concl_assoc1 (hyp_count_addr p) p
