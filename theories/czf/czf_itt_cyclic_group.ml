 ...
 * A group $g$ is @emph{cyclic} if there exists $x @in @car{g}$
 * such that $@car{g}$ is the collection of $x^n$ for all
 * $n @in @int$.
 * @end[doc]
 *
 * ----------------------------------------------------------------
 ...
 * $@mem{a; @car{g}}$, and $@equal{@car{g}; @collect{x; @int; @power{g; a; x}}}$.
 * @end[doc]
 *)
...
(*!
 * @begin[doc]
 * @thysubsection{Constructiveness}
 *
 * Since the CZF set theory is constructive, some classically correct
 * theorems become incorrect here. For example, we cannot prove in CZF
 * that a subgroup of a cyclic group is cyclic. ...
 * @end[doc]
 *)
(*! @docoff *)
(************************************************************************
