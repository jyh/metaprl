 ...
 * @end[doc]
 *)
interactive pair_isset {| intro_resource [] |} 'H :
 ...
 * @end[doc]
 *)
interactive pair_member_intro_left {| intro_resource [SelectOption 1] |} 'H :
...
interactive pair_member_intro_right {| intro_resource [SelectOption 2] |} 'H :
   ["wf"] sequent [squash] { 'H >- isset{'x} } -->
   ["wf"] sequent [squash] { 'H >- isset{'s1} } -->
   ["wf"] sequent [squash] { 'H >- isset{'s2} } -->
 ...
 * @end[doc]
 *)
interactive pair_member_elim {| elim_resource [] |} 'H 'J :
 ...
 * @end[doc]
 *)
interactive pair_fun {| intro_resource [] |} 'H :
