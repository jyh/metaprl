 ...
 * Typehood.
 *)
interactive type_intro_void 'H :
   sequent [squash] { 'H >- Itt_equal!"type"{'A} } -->
   sequent [squash] { 'H >- subtype{'A; void} } -->
   sequent ['ext] { 'H >- "type"{'A} }

interactive type_intro_unit 'H :
   sequent [squash] { 'H >- Itt_equal!"type"{'A} } -->
   sequent [squash] { 'H >- subtype{unit; 'A} } -->
   sequent ['ext] { 'H >- "type"{'A} }
