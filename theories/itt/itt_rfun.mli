 ...
 *)
rule rfunctionEquality lambda{a. lambda{b. 'R['a; 'b]}} 'g 'y 'z :
 ...
 *)
rule rfunction_lambdaFormation lambda{a. lambda{b. 'R['a; 'b]}} 'g 'y 'z :
 ...
 *)
rule rfunction_lambdaEquality 'y :
 ...
 *)
rule rfunctionElimination 'H 'f 'a 'y 'v :
