 ...
 * @end[doc]
 *)
prim srecEquality {| intro []; eqcd |} 'T 'S1 'S2 'z :
...
prim srecType {| intro [] |} 'S1 'S2 'z univ[i:l] :
 ...
 * @end[doc]
 *)
prim srecindEquality {| intro []; eqcd |} lambda{x. 'S['x]} srec{T. 'B['T]} 'T1 'u 'v 'w 'z univ[i:l] :
