 ...
 *)
declare tok_bquote_term  : Terminal
declare tok_squote_term  : Terminal
declare tok_unquote_term : Terminal

lex_token xterm : "[$]`"  --> tok_bquote_term
lex_token xterm : "[$]'"  --> tok_squote_term
lex_token xterm : "[$],"  --> tok_unquote_term

lex_prec nonassoc [tok_squote_term; tok_bquote_term; tok_unquote_term] = prec_not
