...
(*
 * Get a conversion out of a list of iforms and apply it.
 *)
val iforms_conversion : mp_pre_term_rewrite list -> conv
val apply_conversion : conv -> term -> term
...
val compile_phobos_ast :
   term -> mp_pre_term_rewrite list list -> term

val compile_phobos_fir :
   term -> mp_pre_term_rewrite list list -> mp_pre_term list -> unit
