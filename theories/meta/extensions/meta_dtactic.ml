 ...
 *)
let process_meta_intro_resource_annotation name args term_args statement (pre_tactic, options) =
...
let process_meta_elim_resource_annotation name args term_args statement (pre_tactic, options) =
   if args.spec_addrs <> [||] then
