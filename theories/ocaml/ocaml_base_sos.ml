...
rewrite state_unfold : 
   state{'S; 'e} <--> spread{eval{'S; 'e}; v, S2. 'S2}

rewrite expr_unfold :
   expr{'S; 'e} <--> spread{eval{'S; 'e}; v, S2. 'v}
 ...
 *)
axiom functional_apply_value :
   sequent { 'H >- value_equal{'S; 'a1; 'a2; 't2} } -->
   sequent { 'H >- value_equal{'S; 'f1; 'f2; functional{'t1; 't2}} } -->
   sequent { 'H >- value_equal{'S; apply{'f1; 'a1}; apply{'f2; 'a2}; 't2}
