 ...
 * Module name.
 *)
dform ident_expr_cons_df1 : slot{ident_expr; cons{'e1; 'e2}} =
   slot{ident_expr; 'e1; 'e2}

dform ident_expr_cons_df2 : slot{ident_expr; .Ocaml!"string"[@name:s]; cons{'e1; 'e2}} =
   slot[@name:s] `"." slot{ident_expr; 'e1; 'e2}

dform ident_expr_nil_df : slot{ident_expr; .Ocaml!"string"[@name:s]; nil} =
   slot[@name:s]
 ...
 * Tuples.
 *)
dform e_list_nil_df1 : slot{e_list; nil} =
   `""

dform e_list_nil_df2 : slot{e_list; nil; e_list} =
   `""

dform e_list_cons_df1 : slot{e_list; cons{'e1; 'e2}} =
   slot{'e1}
   slot{e_list; 'e2; e_list}

dform e_list_cons_df2 : slot{e_list; cons{'e1; 'e2}; e_list} =
   `"," hspace slot{'e1}
   slot{e_list; 'e2; e_list}
...
dform ee_list_nil_df : slot{ee_list; nil; ee_list} =
   `""

dform ee_list_nil_df1 : slot{ee_list; cons{ee{'e1; 'e2}; 'e3}} =
   szone slot{'e1} hspace "=" hspace slot{'e2} ezone
   slot{ee_list; 'e3; ee_list}

dform ee_list_nil_df2 : slot{ee_list; cons{ee{'e1; 'e2}; 'e3}; ee_list} =
