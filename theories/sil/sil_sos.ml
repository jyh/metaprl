 ...
 *)
prim snumber_eval :
   sequent { <H> >- evalsto{eval{number[i:n]; 's}; ."value"{number[i:n]; 's}}} =
   it

prim add_eval 's2 :
   [main] sequent { <H> >- evalsto{eval{'e1; 's1}; ."value"{number[i:n]; 's2}} } -->
   [main] sequent { <H> >- evalsto{eval{'e2; 's2}; ."value"{number[j:n]; 's3}} } -->
   sequent { <H> >- evalsto{eval{add{'e1; 'e2}; 's1}; ."value"{meta_sum[i:n, j:n]; 's3}} } =
   it
...
prim if_eval_true (number[i:n]) 's2 (number[j:n]) 's3 :
   [main] sequent { <H> >- evalsto{eval{'e1; 's1}; ."value"{number[i:n]; 's2}} } -->
   [main] sequent { <H> >- evalsto{eval{'e2; 's2}; ."value"{number[j:n]; 's3}} } -->
   [assertion] sequent { <H> >- meta_eq[i:n, j:n]{."true"; ."false"} } -->
...
prim inl_eval :
   ...
   sequent { <H> >- evalsto{eval{inl{'e1}; 's1}; ."value"{inl{'v1}; 's2}} } =
   it

prim inr_eval :
   [main] sequent { <H> >- evalsto{eval{'e1; 's1}; ."value"{'v1; 's2}} } -->
   sequent { <H> >- evalsto{eval{inr{'e1}; 's1}; ."value"{inr{'v1}; 's2}} } =
   it

prim decide_eval_left 'v1 's2 :
   [main] sequent { <H> >- evalsto{eval{'e1; 's1}; ."value"{.inl{'v1}; 's2}} } -->
   [main] sequent { <H> >- evalsto{eval{'e2['v1]; 's2}; ."value"{'v2; 's3}} } -->
   sequent { <H> >- evalsto{eval{decide{'e1; x. 'e2['x]; y. 'e3['y]}; 's1}; ."value"{'v2; 's3}} } =
   it

prim decide_eval_right 'v1 's2 :
   [main] sequent { <H> >- evalsto{eval{'e1; 's1}; ."value"{inr{'v1}; 's2}} } -->
   [main] sequent { <H> >- evalsto{eval{'e3['v1]; 's2}; ."value"{'v3; 's3}} } -->
   sequent { <H> >- evalsto{eval{decide{'e1; x. 'e2['x]; y. 'e3['y]}; 's1}; ."value"{'v3; 's3}} } =
   it
...
prim pair_eval 's2 :
   ...
   sequent { <H> >- evalsto{eval{pair{'e1; 'e2}; 's1}; ."value"{pair{'v1; 'v2}; 's3}} } =
   it

prim spread_eval 'v1 'v2 's2 :
   [main] sequent { <H> >- evalsto{eval{'e1; 's1}; ."value"{pair{'v1; 'v2}; 's2}} } -->
   [main] sequent { <H> >- evalsto{eval{'e2['v1; 'v2]; 's2}; ."value"{'v3; 's3}} } -->
   sequent { <H> >- evalsto{eval{spread{'e1; x, y. 'e2['x; 'y]}; 's1}; ."value"{'v3; 's3}} } =
   it
...
prim ref_eval 'v1 's2 :
   [main] sequent { <H> >- evalsto{eval{'e1; 's1}; ."value"{'v1; 's2}} } -->
   sequent { <H> >- evalsto{eval{ref{'e1}; 's1}; alloc{'s2; 'v1; s3, l. "value"{'l; 's3}}} } =
   it
...
prim assign_eval 's2 :
   [main] sequent { <H> >- evalsto{eval{'e1; 's1}; ."value"{'v1; 's2}} } -->
   [main] sequent { <H> >- evalsto{eval{'e2; 's2}; ."value"{'v2; 's3}} } -->
   sequent { <H> >- evalsto{eval{assign{'e1; 'e2}; 's1}; ."value"{.dot; store{'s3; 'v1; 'v2}}} } =
   it

prim dot_eval :
   sequent { <H> >- evalsto{eval{dot; 's1}; ."value"{dot; 's1}} } =
   it
 ...
 *)
prim lambda_eval :
   sequent { <H> >- evalsto{eval{lambda{v. 'e1['v]}; 's1}; ."value"{lambda{v. 'e1['v]}; 's1}} } =
   it

prim apply_eval 'v2 's2 (lambda{v. 'e3['v]}) 's3 :
   [main] sequent { <H> >- evalsto{eval{'e2; 's1}; ."value"{'v2; 's2}} } -->
   [main] sequent { <H> >- evalsto{eval{'e1; 's2}; ."value"{lambda{v. 'e3['v]}; 's3}} } -->
   [main] sequent { <H> >- evalsto{eval{'e3['v2]; 's3}; ."value"{'v3; 's4}} } -->
   sequent { <H> >- evalsto{eval{apply{'e1; 'e2}; 's1}; ."value"{'v3; 's4}} } =
   it
