 ...
 * Need this unhiding.
 *)
interactive unhide_in_domain {| elim_resource [] |} 'H 'J :
...
interactive in_domain_member {| intro_resource [] |} 'H :
 ...
 *)
interactive empty_member2 {| intro_resource [] |} 'H :
