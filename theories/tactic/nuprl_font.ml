...
dform mathbbM_df		: internal :: mode[prl] :: mathbbM                   = `"\140"
dform mathbbN_df		: internal :: mode[prl] :: mathbbN                   = `"\141"
dform mathbbO_df		: internal :: mode[prl] :: mathbbO                   = `"\142"
dform mathbbP_df		: internal :: mode[prl] :: mathbbP                   = `"\143"
dform mathbbQ_df		: internal :: mode[prl] :: mathbbQ                   = `"\144"
dform mathbbR_df		: internal :: mode[prl] :: mathbbR                   = `"\145"
dform mathbbS_df		: internal :: mode[prl] :: mathbbS                   = `"\146"
dform mathbbT_df		: internal :: mode[prl] :: mathbbT                   = `"\147"
dform mathbbU_df		: internal :: mode[prl] :: mathbbU                   = `"\148"
dform mathbbV_df		: internal :: mode[prl] :: mathbbV                   = `"\149"
dform mathbbW_df		: internal :: mode[prl] :: mathbbW                   = `"\150"
dform mathbbX_df		: internal :: mode[prl] :: mathbbX                   = `"\151"
dform mathbbY_df		: internal :: mode[prl] :: mathbbY                   = `"\152"
dform mathbbZ_df		: internal :: mode[prl] :: mathbbZ                   = `"\153"
...
dform shortLeftarrow_df		: internal :: mode[prl] :: shortLeftarrow            = `"\156"
dform leftarrow_df		: internal :: mode[prl] :: Leftarrow                 = `"\156\157"
dform middlearrow_df		: internal :: mode[prl] :: Middlearrow               = `"\157"
dform shortRightarrow_df	: internal :: mode[prl] :: shortRightarrow           = `"\158"
dform rightarrow_df		: internal :: mode[prl] :: Rightarrow                = `"\157\158"
dform leftrightarrow_df		: internal :: mode[prl] :: Leftrightarrow            = `"\156\157\158"
...
dform shortleftrightarrow_df	: internal :: mode[prl] :: shortleftrightarrow       = `"\224"
